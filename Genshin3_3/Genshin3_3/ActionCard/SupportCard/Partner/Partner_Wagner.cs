...
{
    public class Partner_Wagner : AbstractCardSupport
    {
        ...
        public override PersistentTriggerDictionary TriggerDic => new()
        {
            ...
            {
                if (me.TeamIndex==s.TeamID && s is UseDiceFromCardSender ss && ss.Card is AbstractCardWeapon weapon && v is CostVariable cv)
                {
