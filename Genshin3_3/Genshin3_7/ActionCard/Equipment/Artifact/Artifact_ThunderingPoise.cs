...
{
    public class Artifact_ThunderingPoise : AbstractCardArtifact
    {
        ...
        public override PersistentTriggerDictionary TriggerDic => new()
        {
            ...
            { SenderTag.UseDiceFromSkill,new PersistentDiceCostModifier<UseDiceFromSkillSender>(
                (me,p,s,v)=>me.TeamIndex==s.TeamID&&s.Character.Index==p.PersistentRegion&&s.Skill.Category==SkillCategory.A,0,1)},
